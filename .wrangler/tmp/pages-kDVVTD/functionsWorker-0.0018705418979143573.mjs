...
// api/admin/booking-by-airline.js
...
// api/admin/booking-by-country.js
...
var MODEL = "nvidia/nemotron-3.5-lightning:free";
var REQUEST_TIMEOUT_MS = 25e3;
var MAX_HISTORY = 20;
var SYSTEM_PROMPT = `B\u1EA1n l\xE0 tr\u1EE3 l\xFD \u1EA3o c\u1EE7a TravelViet (Du L\u1ECBch Vi\u1EC7t) \u2014 website demo \u0111\u1EB7t v\xE9 m\xE1y bay v\xE0 tour du l\u1ECBch.
Tr\u1EA3 l\u1EDDi b\u1EB1ng ti\u1EBFng Vi\u1EC7t, ng\u1EAFn g\u1ECDn, th\xE2n thi\u1EC7n, \u0111\xFAng tr\u1ECDng t\xE2m.
\u0110\xE2y l\xE0 website demo: kh\xF4ng x\u1EED l\xFD thanh to\xE1n th\u1EADt, kh\xF4ng c\xF3 d\u1EEF li\u1EC7u chuy\u1EBFn bay/tour theo th\u1EDDi gian th\u1EF1c ngo\xE0i nh\u1EEFng g\xEC hi\u1EC3n th\u1ECB tr\xEAn site.
N\u1EBFu kh\xE1ch mu\u1ED1n \u0111\u1EB7t v\xE9/tour, h\u01B0\u1EDBng d\u1EABn h\u1ECD v\xE0o trang Chuy\u1EBFn bay ho\u1EB7c Tour, ch\u1ECDn m\u1EE5c mu\u1ED1n \u0111\u1EB7t v\xE0 b\u1EA5m n\xFAt "Ch\u1ECDn"/"Ch\u1ECDn tour" \u2014 kh\xF4ng t\u1EF1 nh\u1EADn l\xE0 \u0111\xE3 \u0111\u1EB7t gi\xFAp kh\xE1ch.
N\u1EBFu kh\xF4ng ch\u1EAFc th\xF4ng tin c\u1EE5 th\u1EC3 (gi\xE1, gi\u1EDD bay...), n\xF3i r\xF5 kh\xE1ch n\xEAn xem tr\u1EF1c ti\u1EBFp tr\xEAn trang thay v\xEC \u0111o\xE1n s\u1ED1 li\u1EC7u.`;
function sanitizeMessages(input) {
  if (!Array.isArray(input)) return [];
  return input.filter((m) => m && (m.role === "user" || m.role === "assistant") && typeof m.content === "string" && m.content.trim()).slice(-MAX_HISTORY).map((m) => ({ role: m.role, content: m.content.trim() }));
}
...
async function onRequestPost8({ request, env }) {
  ...
  if (!apiKey) return errorJson("Server ch\u01B0a c\u1EA5u h\xECnh API key", 500);
  const body = await readJson(request);
  ...
  try {
    ...
    if (err.name === "AbortError") return errorJson("Chatbot ph\u1EA3n h\u1ED3i qu\xE1 ch\u1EADm, vui l\xF2ng th\u1EED l\u1EA1i.", 504);
    return errorJson("Kh\xF4ng th\u1EC3 k\u1EBFt n\u1ED1i t\u1EDBi chatbot.", 502);
  }
  if (res.status === 429) {
    return errorJson("Chatbot \u0111ang qu\xE1 t\u1EA3i (h\u1EBFt l\u01B0\u1EE3t mi\u1EC5n ph\xED trong ng\xE0y), vui l\xF2ng th\u1EED l\u1EA1i sau.", 429);
  }
  if (!res.ok) {
    return errorJson("Chatbot hi\u1EC7n kh\xF4ng ph\u1EA3n h\u1ED3i \u0111\u01B0\u1EE3c, vui l\xF2ng th\u1EED l\u1EA1i sau.", 502);
  }
  const data = await res.json().catch(() => null);
  const reply = data?.choices?.[0]?.message?.content;
  if (!reply) return errorJson("Kh\xF4ng nh\u1EADn \u0111\u01B0\u1EE3c ph\u1EA3n h\u1ED3i t\u1EEB chatbot.", 502);
  return json({ reply });
}
...
// ../.wrangler/tmp/pages-kDVVTD/functionsRoutes-0.9460856544530245.mjs
var routes = [
  {
...
// C:/Users/PHƯỚC/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/PHƯỚC/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-CYxlTw/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-CYxlTw/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.0018705418979143573.mjs.map
